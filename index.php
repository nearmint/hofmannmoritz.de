...
-->
 ...
 <!-- ToDo:
    ...
    - If one of the icons is clicked, a text bubble should appear under it with some information
    - This website should be online at hofmannmoritz.de/.com
    - fix the text on the business card image: it should look the same in any browser size
